...
export default function FinalTransition({ stats, onNext }: FinalTransitionProps) {
    ...
    return (
        <div className="fixed inset-0 w-screen h-screen flex items-center justify-center bg-black overflow-hidden">
            ...
            <div className="max-w-4xl w-full p-8 text-center relative z-10 space-y-16">
                <motion.div
                ...
                >
                    <div className="relative">
                        ...
                        >
                            <Sparkles className="w-40 h-40 md:w-56 md:h-56 text-white drop-shadow-[0_0_50px_white]" />
                        </motion.div>
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="space-y-8"
                >
                    <h1 className="text-7xl md:text-9xl font-black font-heading text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-glow tracking-tighter loading-tight leading-none">
                        It&apos;s Time
                    </h1>

                    <p className="text-3xl text-white/50 font-light tracking-wide">
